...
const Footer = () => {
  return (
    <footer className="bg-white border-white dark:bg-secondary-700 pt-4 border-t-2 dark:border-secondary-600">
      <Container>
          ...
          <div>
            ...
            <ul className="text-secondary-500 dark:text-secondary-400 font-medium">
              ...
              <li className="flex gap-4 justify-start items-center">
                <a
                  href="#"
                  className="text-secondary-400 hover:text-secondary-900 dark:hover:text-white"
                >
                  <svg
      ...
      <div className="px-4 bg-secondary-100 dark:bg-secondary-700 border-t-2 dark:border-secondary-600">
