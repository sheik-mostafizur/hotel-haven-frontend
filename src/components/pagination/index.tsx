      ...
      <ul className="inline-flex -space-x-px text-sm lg:text-base lg:h-10">
        ...
        <li>
          <a
            href="#"
            aria-current="page"
            className="flex items-center justify-center px-3 lg:px-4 h-8 lg:h-10 text-primary-600 border border-secondary-300 bg-primary-50 hover:bg-primary-100 hover:text-primary-700 dark:border-secondary-700 dark:bg-secondary-600 dark:text-white">
            3
          </a>
        </li>
        <li>
