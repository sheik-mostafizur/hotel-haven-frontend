    ...
    return (
        <div className="bg-white rounded-lg grid grid-cols-1 lg:grid-cols-2 gap-5 lg:p-4  shadow-md border mt-5 p-2">
            <div className="relative  w-full ">
                <Swiper slidesPerView={1} spaceBetween={5} autoplay={{ delay: 2500, disableOnInteraction: false, }}
                    pagination={{ clickable: true, }} navigation={true} modules={[Pagination, Autoplay]}
                    className="mySwiper">
            ...
            <div className="p-4   grid grid-cols-1 lg:grid-cols-2 gap-5   w-full">
                <div className='w-full'>
                    ...
                    <h3 className='text-lg font-semibold w-[25%] mb-2 border-b border-primary-500'>Facilities:
                    </h3>
