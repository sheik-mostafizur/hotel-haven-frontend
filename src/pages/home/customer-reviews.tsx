const CustomerReviews = () => {
  return (
    <div className="my-20">
      ...
      <div className="lg:flex mx-auto justify-center my-6 gap-4 items-center">
        <div>
          <a
            href="#"
          ...
          >
            <img
              className="object-cover rounded-full w-32 h-32 lg:w-52 lg:rounded-t-lg lg:h-96 md:h-auto md:w-48 md:rounded-none md:rounded-l-lg"
            ...
            <div className="flex flex-col justify-between p-4 leading-normal">
              <p className="mb-3 font-normal text-secondary-700 dark:text-secondary-400">
                My stay at Hotel Heaven was pure bliss. Luxurious rooms,
                exquisite dining, and impeccable service. An unforgettable
