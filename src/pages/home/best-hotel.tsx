    ...
    <div className="my-20 mx-auto">
      <div className="mx-auto mb-4">
        <h2 className="text-center lg:text-5xl">
          Hotel Heavens Best Rooms & Suites
        </h2>
        <p className="px-4 lg:px-16 font-normal">
          ...
          epitome of comfort and elegance. Indulge in breathtaking views and
          top-notch amenities for an unforgettable escape. Book your dream
          getaway today for a truly exceptional experience.
        </p>
      </div>
      <div className="grid grid-cols-3 gap-2 mx-auto">
        <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
          <a href="#">
            <img
              className="rounded-t-lg w-96 h-full"
        ...
        <div>
          <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            <a href="#">
              <img
                className="rounded-t-lg w-96 h-full"
                src="https://images.pexels.com/photos/97083/pexels-photo-97083.jpeg?auto=compress&cs=tinysrgb&w=600"
                alt=""
              />
            </a>
            <div className="p-5">
