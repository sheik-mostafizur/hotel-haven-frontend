    ...
    <Swiper
      ...
      <SwiperSlide>
        ...
        <div className="text-center absolute text-white  top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
          ...
          <p className="px-4 lg:px-16 text-white lg:my-2 lg:font-medium">
            Escape to a world of opulence and serenity. Hotel Heaven promises an
            unforgettable experience of luxury, comfort and hospitality.
          </p>
          <div>
      ...
      <SwiperSlide>
        ...
        <div className="text-center absolute text-white top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
          ...
          <p className="px-4 lg:px-16 text-white lg:my-2 font-medium">
            At Hotel Heaven, every moment is a masterpiece. Immerse yourself in
            a haven of indulgence and relaxation
          </p>
          <div>
            <Button>Explore More</Button>
          </div>
      ...
      <SwiperSlide>
        ...
        <div className="text-center absolute text-white  top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
          ...
          <p className="px-4 lg:px-16 text-white lg:my-2 font-medium">
            Experience the pinnacle of hospitality at Hotel Heaven. Your journey
            to pure relaxation begins here.
          </p>
          <div>
            <Button>Explore More</Button>
          </div>
